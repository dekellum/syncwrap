...
* SyncWrap::SystemDService; add enable and disable commands
* SyncWrap::CRubyVM
...
* Expand transitive dependency constraints for new releases:
  term-ansicolor, tins, json and nokogiri. The latest of some tins and
  nokogiri is incompatible with jruby 1.7.x (in 1.9 mode) which
