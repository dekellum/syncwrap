...
* Add SyncWrap::RunUser#run_dir_mode and change the default to
  0755. This was previously hardcoded to 0775, which caused ssh access
  as the :run_user to fail (when :run_dir and :run_user_home are the
  same).
